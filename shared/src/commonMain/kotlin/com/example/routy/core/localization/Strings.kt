...
private val english =
    mapOf(
        ...
        TextKey.Offline to "No connection • showing saved data",
...
private val georgian =
    mapOf(
        ...
        TextKey.Offline to "კავშირი არ არის • ნაჩვენებია შენახული მონაცემები",
        ...
        TextKey.Ocean to "ოკეანე",
        TextKey.Mint to "პიტნა",
        TextKey.Mono to "მონოქრომი",
...
private val russian =
    mapOf(
        ...
        TextKey.Offline to "Нет соединения • показаны сохранённые данные",
